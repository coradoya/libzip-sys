...
pub const LIBZIP_VERSION: &[u8; 6usize] = b"1.7.3\0";
...
fn bindgen_test_layout_zip_source_args_seek() {
    ...
    fn test_field_offset() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_source_args_seek>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_zip_error() {
    ...
    fn test_field_zip_err() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_error>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).zip_err) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_zip_err();
    fn test_field_sys_err() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_error>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).sys_err) as usize - ptr as usize
            },
            4usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_zip_stat() {
    ...
    fn test_field_valid() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_stat>::uninit();
                let ptr = uninit.as_ptr();
    ...
    test_field_size();
    fn test_field_comp_size() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_stat>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).comp_size) as usize - ptr as usize
            },
            32usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_crc() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_stat>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).crc) as usize - ptr as usize
            },
            48usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_crc();
    fn test_field_comp_method() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_stat>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).comp_method) as usize - ptr as usize
            },
            52usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_comp_method();
    fn test_field_encryption_method() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_stat>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).encryption_method) as usize - ptr as usize
            },
            54usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_zip_buffer_fragment() {
    ...
    fn test_field_data() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_buffer_fragment>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_zip_file_attributes() {
    ...
    fn test_field_valid() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_file_attributes>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).valid) as usize - ptr as usize
            },
            0usize,
    ...
    test_field_version();
    fn test_field_host_system() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_file_attributes>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).host_system) as usize - ptr as usize
            },
            9usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_ascii();
    fn test_field_version_needed() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_file_attributes>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).version_needed) as usize - ptr as usize
            },
            11usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_version_needed();
    fn test_field_external_file_attributes() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_file_attributes>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).external_file_attributes) as usize - ptr as usize
            },
            12usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_external_file_attributes();
    fn test_field_general_purpose_bit_flags() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_file_attributes>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).general_purpose_bit_flags) as usize - ptr as usize
            },
            16usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_general_purpose_bit_flags();
    fn test_field_general_purpose_bit_mask() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<zip_file_attributes>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).general_purpose_bit_mask) as usize - ptr as usize
            },
            18usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_general_purpose_bit_mask();
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct zip {
...
extern "C" {
    pub fn zip_archive_set_tempdir(
        arg1: *mut zip_t,
        arg2: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
